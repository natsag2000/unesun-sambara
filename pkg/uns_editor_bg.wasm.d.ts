...
export const wasmeditor_translit_init_canvas: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const wasmeditor_translit_is_loaded: (a: number) => number;
export const wasmeditor_translit_load_dictionary: (a: number, b: number, c: number) => any;
